...
import { controlClass, SectionHeading, YesNoToggle } from "./fields";
...
/** Card shell: bold title + ไม่มี/มี toggle, a subtitle, and expandable body. */
function HealthCard({
  title,
  subtitle,
  has,
  ...
  return (
    <div className="rounded-2xl border border-fd-lightpink p-4">
