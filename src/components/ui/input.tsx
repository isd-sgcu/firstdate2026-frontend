...
const inputVariants = cva(
  "h-10 w-full min-w-0 px-2.5 py-1 text-base transition-colors outline-none file:inline-flex file:h-6 file:border-0 file:text-sm file:font-bold file:text-foreground focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 disabled:pointer-events-none disabled:cursor-not-allowed  disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 text-sm  dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40",
  {
    variants: {
      variant: {
        default:
        ...
        outline:
          "rounded-md border border-foreground bg-transparent file:bg-transparent disabled:bg-input/50 dark:bg-input/30 dark:disabled:bg-input/80 placeholder:text-muted-foreground",
        shadcn:
