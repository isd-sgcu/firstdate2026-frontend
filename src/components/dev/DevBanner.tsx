...
const PRESETS: Preset[] = [
  {
    ...
    body: {
      ...
      firstName: "Somchai",
      lastName: "Freshman",
      registrations: [{ project: "firstdate" }],
    },
  },
  {
    label: "+ Firstdate staff",
    body: { studentId: "6500000001", staffRoles: ["firstdate"] },
  },
];
...
function DevBannerInner() {
  ...
  async function seed() {
    try {
      await devFetch("/v1/dev/seed", devKey, { method: "POST", body: {} });
      setMessage("seeded baseline fixtures");
    } catch (err) {
